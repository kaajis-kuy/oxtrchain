...
import (
	...
	"cosmossdk.io/crypto/hd"
	"cosmossdk.io/crypto/keyring"
	cryptotypes "cosmossdk.io/crypto/types"
	"cosmossdk.io/server"
	srvconfig "cosmossdk.io/server/config"
	"cosmossdk.io/testutil"
...
Example:
	oxtrchaind multi-node --v 4 --output-dir ./.testnets --validators-stake-amount 1000000,200000,300000,400000 --list-ports 47222,50434,52851,44210
	`,
